<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DetailResettingSLA.aspx.cs" Inherits="PertaminaSLA.DetailResettingSLA" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <section class="invoice" style="border: 2px solid #d2d6de;">
                        ...
                        <div id="tblPengguna" runat="server">
                            ...
                            <div class="col-sm-12 invoice-col">
                                <div class="form-group">
                                    <div class="col-sm-12"><br />
                                        <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-info"><span class="fa fa-comments-o"></span> Komentar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-12">
                            <asp:HyperLink runat="server" Text="Select" NavigateUrl="~/ResettingSLA.aspx" CssClass="btn btn-warning"><span class="glyphicon glyphicon-menu-left"></span> Kembali</asp:HyperLink>
                            <button type="button" onclick="alertReset()" class="btn btn-danger pull-right"><span class="glyphicon glyphicon-refresh"></span> Reset Full</button>
                            <button type="button" onclick="alertReset()" class="btn btn-danger pull-right" style="margin-right:10px"><span class="glyphicon glyphicon-refresh"></span> Reset Activity</button>
                        </div>
                    </div>
    ...
    <script>
        function alertReset() {
            swal("Reset!", "Data berhasil direset!", "success");
        }
    </script>
