<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DetailMonitoringPengguna.aspx.cs" Inherits="PertaminaSLA.DetailMonitoringPengguna" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section class="content-header">
        <h1>Monitoring Pengguna
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="glyphicon glyphicon-home"></i>Home</a></li>
            <li class="active">Monitoring Pengguna</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Monitoring Pengguna</h3>
                ...
                <div class="row">
                    ...
                    <section class="invoice" style="border: 2px solid #d2d6de;">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h2 class="page-header">
                                    <i class=""></i>Tanggapan Pengguna Layanan
                                </h2>
                            </div>
                            <!-- /.col -->
                        </div>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-12">
                            <asp:HyperLink runat="server" Text="Select" NavigateUrl="~/MonitoringPengguna.aspx" CssClass="btn btn-warning"><span class="glyphicon glyphicon-menu-left"></span> Kembali</asp:HyperLink>
                            ...
                            <button type="button" class="btn btn-danger pull-right" style="margin-right: 5px;"><span class="glyphicon glyphicon-remove"></span> Batal</button>--%>
                              <button type="button" onclick="alertSuccess()" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-ok"></span> Approve</button>
                            <button type="button" class="btn btn-danger pull-right" style="margin-right: 5px;"><span class="glyphicon glyphicon-remove"></span> Revise</button>
                        </div>
                    </div>
                </div>
            </div>
