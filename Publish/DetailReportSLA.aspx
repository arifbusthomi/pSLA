<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DetailReportSLA.aspx.cs" Inherits="PertaminaSLA.DetailReportSLA" %>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <asp:HyperLink runat="server" Text="Select" NavigateUrl="~/ReportSLA.aspx" CssClass="btn btn-warning"><span class="glyphicon glyphicon-menu-left"></span> Kembali</asp:HyperLink>
                        <button type="button" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-download"></span> Save To PDF</button>
                    </div>
                </div>
            </div>
