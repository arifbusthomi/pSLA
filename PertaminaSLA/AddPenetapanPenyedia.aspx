<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddPenetapanPenyedia.aspx.cs" Inherits="PertaminaSLA.AddPenetapanPenyedia" %>
                    ...
                    <div class="box-body">
                        <div class="col-md-12">
                            <dl>
                                ...
                                <dd>SPV Exploration</dd>
                            </dl>
                            <button type="button" data-toggle="modal" class="btn btn-primary" data-target="#myModalSub">Tambah</button>
                        </div>
                        <br />
                        <div class="col-md-12">
                                ...
                                <table class="table table-hover" style="border: 1px solid #00a65a;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Test</td>
                                            <td>
                                                <button type="button" data-toggle="modal" class="btn btn-primary" data-target="#myModalSub">Edit</button></td>
                                            <td>
                    ...
                    <section class="invoice" style="border: 2px solid #d2d6de;">
                        ...
                        <div class="row invoice-info">
                                ...
                                <div class="box-body table-responsive no-padding">
                                    <table class="table table-hover" style="border: 1px solid #00a65a;">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>1</td>
                                                <td><span class="fa fa-fw fa-file-pdf-o"></span></td>
                                                <td>Dokumen A</td>
                                                <td>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                <td>3</td>
                                                <td><span class="fa fa-fw fa-file-word-o"></span></td>
                                                <td>Dokumen C</td>
                                                <td>
                                                    <button type="button" class="btn btn-primary pull-left"><span class="glyphicon glyphicon-download-alt"></span>Download</button></td>
                                                <td>
                            ...
                            <div class="col-sm-12 invoice-col">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="button" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-upload"></span> Upload</button>
                                        <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-info pull-right" style="margin-right: 5px;"><span class="fa fa-comments-o"></span> Komentar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
