<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MonitoringPengguna.aspx.cs" Inherits="PertaminaSLA.MonitoringPengguna" %>
                        ...
                        <table class="table table-hover" style="border: 1px solid #00a65a;">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Input SLA</td>
                                    <td>
                                        <asp:HyperLink CssClass="btn btn-success" runat="server" NavigateUrl="~/DetailMonitoringPengguna.aspx"><span class="glyphicon glyphicon-open"></span> Lihat</asp:HyperLink></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
