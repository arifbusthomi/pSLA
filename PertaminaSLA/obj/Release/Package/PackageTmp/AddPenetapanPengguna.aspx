<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddPenetapanPengguna.aspx.cs" Inherits="PertaminaSLA.AddPenetapanPengguna" %>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-12">
                            <asp:HyperLink runat="server" Text="Select" NavigateUrl="~/PenetapanPengguna.aspx" CssClass="btn btn-warning"><span class="glyphicon glyphicon-menu-left"></span> Kembali</asp:HyperLink>
