<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResettingSLA.aspx.cs" Inherits="PertaminaSLA.ResettingSLA" %>
                        ...
                        <table class="table table-hover" style="border: 1px solid #00a65a;">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Input SLA</td>
                                    <td>
                                        <asp:HyperLink runat="server" CssClass="btn btn-success" NavigateUrl="~/DetailResettingSLA.aspx"><span class="glyphicon glyphicon-open"></span> Lihat</asp:HyperLink></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
