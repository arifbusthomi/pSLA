<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportSLA.aspx.cs" Inherits="PertaminaSLA.ReportSLA" %>
                        ...
                        <table class="table table-hover" style="border: 1px solid #00a65a;">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Input SLA</td>
                                    <td>
                                        <asp:HyperLink CssClass="btn btn-success" runat="server" onclick="window.open('../report.aspx','name','width=600,height=400')"><span class="glyphicon glyphicon-open"></span> Lihat</asp:HyperLink></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
